		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img src="{{ URL::to(Auth::guard('admin')->user()->image) }}" width="40" height="40" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						<span class="user-img">
						<img src="{{ URL::to(Auth::guard('admin')->user()->image) }}" alt="{{ Auth::user()->name }}">
						<span class="status online"></span></span>
						<span>{{ Session::get('name') }}</span>
					</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ route('profile_user') }}">ملفي</a>
						<a class="dropdown-item" href="{{ route('change/password') }}"> إعادة تعيين كلمة المرور</a>
